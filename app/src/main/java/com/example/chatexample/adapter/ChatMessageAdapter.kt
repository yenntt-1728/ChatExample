...
import com.example.chatexample.databinding.ImageMessageBinding
import com.example.chatexample.databinding.MessageBinding
import com.example.chatexample.ui.utils.Constant.ANONYMOUS
    ...
    inner class MessageViewHolder(private val binding: MessageBinding) : ViewHolder(binding.root) {
        fun bind(item: FriendlyMessage) {
            ...
            if (item.photoUrl != null) {
                ...
                binding.messengerImageView.setImageResource(R.drawable.ic_person)
            }
        }
        ...
        private fun setTextColor(userName: String?, textView: TextView) {
            if (userName != ANONYMOUS && currentUserName == userName && userName != null) {
                ...
                textView.setBackgroundResource(R.drawable.rounded_message_grey)
